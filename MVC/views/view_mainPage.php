<section class="blog-section pt-120">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="section-header">
                        <p>Hsto iaculis mauris nec dis, donec nulla quam quisque amet nulla. Parturient mattis, urna cras eleifend metus, varius turpis enim Tellus at libero eu et, felis id rhonc eros dui. Elementum ante congue odio duis mollis nulla quis <br><br>Im not reading allat<br> -Albert Wesker</p>
                    </div>
                </div>
            </div>
